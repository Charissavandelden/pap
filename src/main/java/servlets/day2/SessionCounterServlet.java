...
public class SessionCounterServlet extends HttpServlet implements AbstractServletInterface
{
    ...
    protected void doGet(HttpServletRequest request, 
        ...
        out.println("<h1>Session counter demo</h1>");
    ...
    protected void doPost(HttpServletRequest request, 
        ...
        if ("clear".equals(action)) {
        	session.invalidate();
        	response.sendRedirect("/session-counter");
        	return;
        }
